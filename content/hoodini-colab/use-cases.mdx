...
Add functional annotations with MetaCerberus.

**Scenario**: You want to annotate protein domains in the extracted neighborhoods.

**Configuration**:
1. Enable **MetaCerberus** in Annotations
2. Select databases relevant to your research:
   - **pfam** — Protein families
   - **cog** — Clusters of Orthologous Groups
   - **kegg** / **kofam** — Metabolic pathways
   - **cazy** — Carbohydrate-active enzymes
   - **phrog** — Prokaryotic virus proteins
   - **vog** — Virus orthologous groups
   - **amrfinder** — Antimicrobial resistance

<Callout type="warning">
  **Database downloads**: Select only the databases you need. Each database adds download time on first use.
</Callout>
